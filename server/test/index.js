...
describe('Task [endpoint]:', function() {
  ...
  it('should return the complete information of a task referenced by its id when contacted on /task/{id}', function(done){
    var options = {
      method: 'GET',
      url: '/tasks/1'
    };
  ...
  it("should return 'This task doesn't exist' when contacted on /task/tasks/{id} when id doesn't exist", function(done){
    var options = {
      method: 'GET',
      url: '/tasks/22'
    };
